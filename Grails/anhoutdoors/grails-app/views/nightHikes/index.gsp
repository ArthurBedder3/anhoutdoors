<html>
    <head>
        <title>A &amp; H Outdoors - Night Hikes</title>
    ...
    <body>
	 <div class="span-1 first">
	  ...
	  <div class="span-22">
        <BR/>
		<h2 id="green">Night Hikes</h2>
		<BR>
		Our day hikes are leaders choice unless otherwise noted. Some of the hikes include dinner cooked 
		at a location where we can watch the moon rise. If you are interested in joining us for one of 
		those hikes and have some dietary requirements please let us know when you register. All fees are 
		per person. 
		<BR>
		Good Hiking boots and a Flashlight or headlamp are required. 
		<BR>
		<BR>
		...
		<BR>
			...
			<g:currentYear /> Night Hiking schedule
	        </span>
			<SPAN
